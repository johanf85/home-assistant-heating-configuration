...
## 4.1 Configuration in Home Assistant
...
#### 4.1.3.3 Correction of temperature sensors
...
#### 4.1.3.4 Trend sensor for possible open window detection
...
#### 4.1.4.1 Setting temperature time program
...
##### 4.1.4.1.1 Bedroom set temperature after bedtime
...
#### 4.1.4.2 Automations for presence detection

##### 4.1.4.2.1 Automation for minimum of two movements detected to trigger other automations
...
##### 4.1.4.2.2 Reset the one-before-last-input boolean 31 minutes before waking time
...
##### 4.1.4.2.3 Automation to turn on someone home status
...
##### 4.1.4.2.4 Behavior based on smart phone location with Home Assistant app
...
### 4.1.5 Heat for 5 minutes straight

##### 4.1.5.1.1 Automation:
...
### 4.1.6 Window open detection (based on speed of temperature rise)
...
##### 4.1.6.1.1 Revert back to programmed set temperature after manual change  
...
##### 4.1.6.1.2 Telegram notification hours of heating past week on Sunday
...
##### 4.1.6.1.3 Turn of heating when there is no signal of DS18B20 temperature sensor
...
##### 4.1.6.1.4 Controlling two generic thermostat entities
...
###### 4.1.6.1.4.1 Living room thermostat turn on
...
###### 4.1.6.1.4.2 Bedroom thermostat turn on / off 
